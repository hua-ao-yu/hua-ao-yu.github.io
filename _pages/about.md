...
目前于天津大学医学工程与转化医学研究院攻读硕士，导师为[许敏鹏教授](https://mctu.tju.edu.cn/info/1193/3489.htm)，我的研究方向主要包括基于深度学习的脑机接口模式识别、不同深度学习网络框架对分类器性能的影响、微弱时域特征脑电信号的数据增强、基于Unity的脑控游戏系统。
